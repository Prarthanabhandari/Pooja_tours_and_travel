...
export default function Reviews({ setCurrentPage }) {
  ...
  return (
    <section id="reviews-section" className="py-16 bg-[#fafcff] w-full overflow-hidden select-none relative">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="mt-12 text-center flex flex-col sm:flex-row gap-4 justify-center items-center relative z-10">
          <button 
            onClick={() => {
              setCurrentPage('testimonials');
              window.scrollTo({ top: 0, behavior: 'smooth' });
            }}
            className="px-6 py-3 bg-[#00b4d8] hover:bg-[#0083b0] text-white font-extrabold text-xs rounded-xl shadow-md shadow-[#00b4d8]/15 hover:-translate-y-0.5 transition-all duration-300 uppercase tracking-wider flex items-center gap-1.5"
          ...
          <button 
            ...
            className="px-6 py-3 bg-white hover:bg-slate-50 text-slate-700 border border-slate-200/80 font-extrabold text-xs rounded-xl hover:-translate-y-0.5 transition-all duration-300 uppercase tracking-wider flex items-center gap-1.5"
            style={{ cursor: 'pointer' }}
          >

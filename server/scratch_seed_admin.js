  ...
  try {
    ...
    if (res.rows.length === 0) {
      await db.query(
        ...
        ['Ajay Basawraj Bhandari', 'booking.poojatravel@gmail.com', 'Pooja@1111', '9623324139', 'admin']
      );
      ...
      await db.query(
        ...
        ['Ajay Basawraj Bhandari', 'Pooja@1111', '9623324139', 'booking.poojatravel@gmail.com']
      );
      console.log('✅ Admin info updated to Ajay Basawraj Bhandari / 9623324139 in PostgreSQL database.');
    }
  } catch (err) {
